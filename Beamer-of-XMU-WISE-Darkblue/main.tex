...
\author[RankFan \& Gauss]{\small{RankFan\inst{1}\inst{2} \and Gauss\inst{1} \inst{2}}} % \it {\color{WisePurple} WISE}{\color{WiseRed}R}

\institute[X~M~U]{
  \inst{1}
  WISE Xiamen University (Xiamen) % if the str is too long, you can use '//' command
  \and
  \inst{2}
  经济知识综合(公众号)
  }
...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \item Github hyperlinks: \alertc{\href{https://github.com/RankXiaoLong/Beamer-of-XMU-WISERCLUB}{click here:Beamer-of-XMU-WISERCLUB \& WISE}}
      \begin{itemize}
...
\begin{frame}
  ...
  \begin{itemize}
    \item \alert{Specific statistical methods for many research problems}
    \item Hyperlinks (\alertc{\href{http://github.com/izahn/iqss-beamer-theme}{click here}}) 
      \begin{itemize}
      \item How to learn (or create) new methods
